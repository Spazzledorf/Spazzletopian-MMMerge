...
function events.ContinentChange1()
	...
	vars.ContData.LastFountain = vars.ContData.LastFountain or {}
	if MV.Continent and MV.Continent > 0 then
		u1[0x51D819] = vars.ContData.LastFountain[MV.Continent] or 0
	end
end
...
function events.BeforeSaveGame()
	...
	vars.ContData.LastFountain = vars.ContData.LastFountain or {}
	if MV.Continent and MV.Continent > 0 then
		vars.ContData.LastFountain[MV.Continent] = u1[0x51D819]
	end
end
